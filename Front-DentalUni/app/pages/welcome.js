export const WelcomeComponent = {
    template: `
<div class="relative min-h-screen flex flex-col sm:justify-center items-center bg-no-repeat bg-contain bg-center bg-red-900" style="background-image: url(https://blog.goldencross.com.br/wp-content/uploads/2019/01/269174-consulta-ao-dentista-afinal-com-qual-frequencia-devo-ir.jpg)">
    <p class="text-black tracking-widest italic underline font-mono text-7xl text-center">
    <h1>Dental</h1>
    <h1>Uni</h1>
    </p>
    <p class="text-4xl text-center text-black"><br>Acessar listagem</br><br> de Dentistas: </p><br><br><br>    
